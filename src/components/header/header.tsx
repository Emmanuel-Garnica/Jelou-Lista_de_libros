  ...
  return (
    ...
    <nav className="bg-white border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        <a href="/Jelou-Lista_de_libros" className="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <div className="w-auto block" id="navbar-default">
          <ul className="font-medium flex md:p-0 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
            <li className='flex items-center'>
              <a href="/Jelou-Lista_de_libros" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-primary md:p-0">Inicio</a>
            </li>
